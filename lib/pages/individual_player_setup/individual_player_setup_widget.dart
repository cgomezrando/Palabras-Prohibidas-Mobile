...
import 'individual_player_setup_model.dart';
export 'individual_player_setup_model.dart';

class IndividualPlayerSetupWidget extends StatefulWidget {
  const IndividualPlayerSetupWidget({super.key});

  static String routeName = 'IndividualPlayerSetup';
  static String routePath = '/individualPlayerSetup';

  @override
  State<IndividualPlayerSetupWidget> createState() =>
      _IndividualPlayerSetupWidgetState();
}

class _IndividualPlayerSetupWidgetState
    extends State<IndividualPlayerSetupWidget> {
  late IndividualPlayerSetupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndividualPlayerSetupModel());
